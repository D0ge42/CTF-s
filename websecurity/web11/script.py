...
# Whats a CSRF Token? Its a token generated by a server-side application and provided to the client(user's browser). It is used to prevent CSRF attacks, whicih occur when a malicious website
